// 'use strict';
import {gameEndHandler, drawWinningLine, rematchButtonHandler, gameLayoutVariables} from '../util/gameEnd'
...
export class Play extends Phaser.State {
    preload() {
      ...
      clickHandlerMulti(sprite, pointer) {
